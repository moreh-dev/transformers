...
from transformers import (
    ...
    Seq2SeqTrainingArguments, default_data_collator, set_seed)
...
class DataTrainingArguments:
    ...
    validation_file: Optional[str] = field(
        ...
        metadata={
            "help":
            "An optional input evaluation data file to evaluate the metrics (sacrebleu) on a jsonlines file."
        },
    )
    test_file: Optional[str] = field(
        ...
        metadata={
            "help":
            "An optional input test data file to evaluate the metrics (sacrebleu) on a jsonlines file."
        },
    )
