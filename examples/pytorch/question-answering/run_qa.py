...
from transformers import (AutoConfig, AutoModelForQuestionAnswering,
                          ...
                          PreTrainedTokenizerFast, TrainerCallback,
...
class TBTrainerCallback(TrainerCallback):
    ...
    def on_evaluate(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
        eval_exact_match = (
            0.0 if state.log_history[-1]["eval_exact_match"] is None else state.log_history[-1]["eval_exact_match"]
        )
        eval_f1 = 0.0 if state.log_history[-1]["eval_f1"] is None else state.log_history[-1]["eval_f1"]
